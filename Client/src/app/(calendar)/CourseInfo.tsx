...
import { Pressable, useColorScheme, View, Text, ScrollView, SafeAreaView } from "react-native";
...
const CourseInfo = () => {
    const { event: rawEvent, startTimeString, endTimeString } = useLocalSearchParams();
    const event = JSON.parse(decodeURIComponent(rawEvent as string)) as RawEventProp;
