...
export const calculateDayHeight = (containerHeight: number, hoursContainerHeight: number) => {
...
export const calculateHourHeight = (hoursContainerHeight: number, totalHours: number) => {
