...
import { startOfWeek, subWeeks, addWeeks, isSameWeek, isSaturday, isSunday, setDay } from 'date-fns';
...
const MenuPlan: React.FC = () => {
    ...
    const endOfMenuDate = startOfWeek(addWeeks(todaysDate, 1), { weekStartsOn: 1 });
