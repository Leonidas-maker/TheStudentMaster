...
const Navigator: React.FC<NavigatorProps> = ({
    ...
    const effectiveIsExternalLink = isExternalLink.length === 0 ? texts.map(() => false) : isExternalLink;
                    ...
                    <View key={index}>
                        ...
                        >
                            <View className="flex-row justify-between items-center">
                                ...
                                <Icon name={effectiveIsExternalLink[index] ? "open-in-new" : "arrow-forward-ios"} size={20} color="#E0E0E2" />
                            </View>
                        </TouchableOpacity>
