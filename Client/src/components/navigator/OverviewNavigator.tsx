...
function OverviewNavigator() {
  ...
  return (
    <View className="m-4">
      <Text className="text-font_primary text-xl font-bold mb-2">
        Alle Seiten
      </Text>
      <View className="bg-secondary rounded-lg shadow-md p-4 border border-gray-700">
        <TouchableOpacity onPress={handleLoadingPress}>
        ...
        <View className="border-b border-gray-700 my-2" />
        <TouchableOpacity onPress={handleDisclosurePress}>
          <View className="flex-row justify-between items-center">
            <View className="flex-row items-center">
        ...
        <TouchableOpacity
          onPress={() =>
            Linking.openURL(
              "https://github.com/Leonidas-maker/TheStudentMaster",
            )
          }
        >
          <View className="flex-row justify-between items-center">
            ...
            <TouchableOpacity onPress={handleLoginPress}>
              <View className="flex-row justify-between items-center">
                <View className="flex-row items-center">
                  ...
                  <Text className="text-green-500 font-bold text-lg ml-2">
                    Anmelden
                  </Text>
                </View>
                <Icon name="arrow-forward-ios" size={20} color="#E0E0E2" />
