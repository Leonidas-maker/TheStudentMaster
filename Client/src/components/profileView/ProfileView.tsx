            ...
            <TouchableOpacity
                ...
                >
                    <View className="flex-row justify-between items-center">
                        ...
                        <View className="ml-2">
                            <Text className="text-font_primary font-bold text-2xl">Account Name</Text>
                            <Text className="text-font_primary font-bold text-md">@AccountName</Text>
                        </View>
                        <Icon name="arrow-forward-ios" size={30} color="#E0E0E2" style={{ marginLeft: 'auto' }} />
                    </View>
                </TouchableOpacity>
            </View>
        </View>
