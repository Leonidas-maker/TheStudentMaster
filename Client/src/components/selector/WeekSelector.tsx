...
const WeekSelector: React.FC<WeekSelectProps> = ({
    ...
    switch (mode) {
            ...
            return (
                <View className="flex-row justify-between px-5 py-3">
                    <TouchableOpacity onPress={onBackPress} disabled={isBackDisabled}>
                        <Icon name="arrow-back-ios" size={30} color={isBackDisabled ? "#A0A0A2" : "#E0E0E2"} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={onForwardPress} disabled={isForwardDisabled}>
                        <Icon name="arrow-forward-ios" size={30} color={isForwardDisabled ? "#A0A0A2" : "#E0E0E2"} />
                    </TouchableOpacity>
                </View>
            );
        case "calendar":
        ...
        default:
            ...
            console.error("Incorrect mode: '" + mode + "'. Please choose 'menu' or 'calendar'.");
            return null;
    }
};
