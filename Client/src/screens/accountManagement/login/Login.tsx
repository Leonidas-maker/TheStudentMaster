    ...
    <TouchableOpacity activeOpacity={1} onPress={dismissKeyboard}>
      <ScrollView className="h-screen bg-primary">
        <View className="pt-10 justify-center items-center">
          ...
          <TextInput
            className="bg-white w-3/4 h-10 rounded-xl border-2 border-white focus:border-red-500 opacity-50"
            autoCapitalize="none"
            autoFocus={true}
            enterKeyHint="next"
          ...
          />
          <TextInput
            className="bg-white w-3/4 h-10 rounded-xl border-2 border-white focus:border-red-500 opacity-50 mt-3"
            autoCapitalize="none"
            enterKeyHint="done"
            placeholder="Passwort"
            placeholderTextColor={"#733932"}
          ...
          <TouchableOpacity className="w-3/4">
            <View className="justify-center items-center">
              <Text className="text-white text-xs">
                Noch kein Konto?{" "}
                <Text className="underline">Hier registrieren</Text>
              </Text>
            </View>
          </TouchableOpacity>
        </View>
