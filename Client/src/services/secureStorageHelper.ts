...
const storeMailServerCredentials = async (username: string, password: string) => {
    try {
...
export { getSecret, storeSecret, removeSecret, getMailServerCredentials, storeMailServerCredentials };