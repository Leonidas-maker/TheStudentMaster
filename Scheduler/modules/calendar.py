...
# ~~~~~~~~~~~~~~~~~ Schemas ~~~~~~~~~~~~~~~~ #
from schemes import s_general, s_calendar
...
def refresh_all_dhbw_calendars(db: Session, console: Console, progress: Progress, task_id: int):
    """
...
def update_all_dhbw_calendars(db: Session, progress, task_id: int, console: Console):
    """
    ...
    try:
        ...
        new_sites_data: Dict[str, s_calendar.DHBWCourseUpdate] = fetcher.get_updated_calendars()
